    ...
    <Box sx={{ display: "grid", gridTemplateColumns: { md: "1.15fr 1fr" }, gap: 3 }}>
      ...
      <Card elevation={0}>
        <CardContent sx={{ p: 3 }}>
          ...
          <TextField
            multiline minRows={7} fullWidth variant="outlined"
          ...
          <Box sx={{
            ...
            p: 1.5, borderRadius: 3, bgcolor: "#e8f0fe", border: "1px solid #c5d9f8",
          }}>
            ...
            <Typography variant="caption" color="text.secondary" lineHeight={1.5}>
              ...
              El modelo detecta 7 tipos de toxicidad distintos.
            </Typography>
          </Box>
        </CardContent>
      </Card>
            ...
            {result && (
              <motion.div key="result"
                ...
                <Box sx={{
                  ...
                  <Box>
                    <Typography variant="caption" fontWeight={700}
                      sx={{ color: cfg.color, textTransform: "uppercase", letterSpacing: 1.5 }}>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                  ...
                  <Box>
                    <Button fullWidth variant="outlined" size="small" color="primary"
                      ...
                      endIcon={<ExpandMoreIcon sx={{ transform: showType ? "rotate(180deg)" : "none", transition: "transform 0.2s" }} />}
                    ...
                    <Collapse in={showType}>
                      <Box sx={{ mt: 1, p: 1.5, borderRadius: 3, bgcolor: "#f8f9fa", border: "1px solid #e8eaed" }}>
                  ...
                  <Box>
                    <Button fullWidth variant="outlined" size="small" color="primary"
                      startIcon={<CodeIcon />}
                      endIcon={<ExpandMoreIcon sx={{ transform: showCode ? "rotate(180deg)" : "none", transition: "transform 0.2s" }} />}
                    ...
                    <Collapse in={showCode}>
                      <Box sx={{
                        mt: 1, p: 1.5, borderRadius: 3, bgcolor: "#f1f3f4", border: "1px solid #e8eaed",
