...
import {
  ...
  LinearProgress, Chip, Alert, Slider, CircularProgress,
} from "@mui/material";
import {
      ...
      <Card elevation={0}>
        <CardContent sx={{ p: 3 }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, mb: 2 }}>
            <Box sx={{ width: 44, height: 44, borderRadius: 2, bgcolor: "#fce8e6",
          ...
          <TextField
            ...
            InputProps={{ startAdornment: <YouTubeIcon sx={{ color: G_RED, mr: 1, flexShrink: 0 }} /> }}
            sx={{ mb: 2.5 }}
          />
          ...
          <Box sx={{ mb: 2.5 }}>
            ...
            <Slider
              value={limit} onChange={(_, v) => setLimit(v)}
          ...
          <Box sx={{ mt: 2, p: 1.5, borderRadius: 3, bgcolor: "#fef7e0", border: "1px solid #fdd663" }}>
            <Typography variant="caption" color="text.secondary" lineHeight={1.5}>
              ...
              unos segundos dependiendo del número de comentarios. Algunos vídeos con comentarios
              desactivados no pueden analizarse.
            </Typography>
          </Box>
        </CardContent>
      </Card>
            ...
            <Card elevation={0} sx={{ mb: 2.5 }}>
              <CardContent sx={{ p: 3 }}>
                <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 2 }}>
                  <Typography variant="h6" fontWeight={700}>📊 Resumen del análisis</Typography>
                ...
                <Box sx={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 2, mb: 2.5 }}>
                  {[
                    ...
                    <Box key={lbl} sx={{ bgcolor: bg, borderRadius: 3, px: 2, py: 1.5,
                ...
                <Box>
                  ...
                  <LinearProgress variant="determinate" value={result.toxic_pct}
                    sx={{
                      height: 8, borderRadius: 100, bgcolor: "#e6f4ea",
